...
export default class EditButton extends Component {
  ...
  //handleClick = () => window.open(`https://jupyter.${location.host}/spawn?profile=exp-${this.pid}&next=`, '_blank');
  handleClick = () => window.open(`https://jupyter.${location.host}/spawn?profile=exp-${this.pid}&next=asdc/browse?project=${this.pid}&task=${this.tid}`, '_blank');
